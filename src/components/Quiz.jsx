...
export default function Quiz(props) {
  ...
  return (
    ...
    <div className="question-div">
            <svg className="quiz-svg-top" xmlns="http://www.w3.org/2000/svg" width="158" height="141" viewBox="0 0 158 141" fill="none">
    ...
    <svg className="quiz-svg-bottom" xmlns="http://www.w3.org/2000/svg" width="148" height="118" viewBox="0 0 148 118" fill="none">
